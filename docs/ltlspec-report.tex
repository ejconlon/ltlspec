...
In this paper, we:
\begin{itemize}
  \item Present the concept of a first-order logical \textit{theory} of a domain
...
\caption{Theory for a trivial ping system}
\end{figure}
...
\caption{Haskell definition of a bridge}
\end{figure}
