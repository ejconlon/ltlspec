...
data EnvProp v =
  EnvProp !(Env v) !Prop
-- Evaluate an LTL Proposition based on a world
...
The theory for chatting room example is presented in Figure~\ref{fig:chat-theory}.

\begin{figure}[ht]
  {
    \fontsize{10}{12}\selectfont
    \input{../gendocs/tex/chat.tex}
  }
...
The theory for Dinning Philosopher example is presented in Figure~\ref{fig:phil-theory}.

\begin{figure}[ht]
  {
    \fontsize{10}{12}\selectfont
    \input{../gendocs/tex/phil.tex}
  }
