...
Figure~\ref{fig:theory-sig} shows a simplified AST of a theory in \ltlspec. The restrictions mentioned above can be shown here in the structure of types and proposisions. The actual representation contains comments and syntax sugar we remove before interpretation.
